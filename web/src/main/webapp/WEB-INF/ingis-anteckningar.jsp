...
<html>
    ...
    <body>
        ...
        @POST ,med base64-encoded   (referens till fil (base64))
        curl -v -H "Accept: application/json" -H "Content-type: application/json" -X POST -d @meta_and_image.json http://127.0.0.1:8080/MediaServerResteasy/media/post
