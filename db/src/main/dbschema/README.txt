0) Check out the docker-machine at @ToDO else do the steps
...
3.1) mysql> CREATE database media;
3.2) mysql> GRANT ALL PRIVILEGES ON nrm_demo_media.* To 'media'@'localhost' IDENTIFIED BY 'mediaserver';
...
see -> https://gist.github.com/Inkimar/d81639a9cd41e96903bfbaa9d07decff
